...
#else
#ifdef GCWZERO //triplebuffer
#define VIDEO_FLAGS_INIT SDL_HWSURFACE|SDL_FULLSCREEN|SDL_TRIPLEBUF
#else
...
#ifdef GCWZERO //triplebuffer
#define VIDEO_FLAGS VIDEO_FLAGS_INIT | SDL_TRIPLEBUF | SDL_FULLSCREEN
#else
