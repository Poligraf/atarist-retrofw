...
#elif GCWZERO //change default diskimage directory
#define MENU_DIR_DEFAULT "/home/retrofw/.DCaSTaway/diskimages"
#else
#define MENU_DIR_DEFAULT "."
#endif
...
void drawNoRom(void);
#ifdef GCWZERO //create global variable for A-mouse
extern int gcw_use_analog_pad;
#endif
#else
