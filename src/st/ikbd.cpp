...
{
#ifdef GCWZERO //change starting coordinates of mouse
    static int xant=160, yant=100;
#else
    static int xant=0, yant=0;
#endif

#ifdef GCWZERO //If mouse moves on x axis we don't change y position and vice versa
    if (dx == 0) {
    	x=xant;
    }
    if (dy == 0) {
